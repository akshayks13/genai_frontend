...
import { User, Mail, BookOpen, Lock, Eye, EyeOff, CheckCircle, ArrowRight, UserPlus, Sparkles, Shield, Star } from 'lucide-react';
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Join thousands of readers and discover your next favorite book in our curated collection.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="areaOfInterest" className="block text-sm font-semibold text-gray-700">
                      Reading Interest
                    </label>
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="poetry">Poetry & Classics</option>
                        <option value="business">Business & Self-Help</option>
                      </select>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <label htmlFor="agreeToTerms" className="text-sm text-gray-600 leading-6">
                      I agree to the{' '}
                      <a href="/terms" className="text-emerald-500 hover:text-emerald-600 font-semibold transition-colors underline decoration-emerald-300 hover:decoration-emerald-500">
                        Terms & Conditions
                      </a>
                      {' '}and{' '}
                      <a href="/privacy" className="text-emerald-500 hover:text-emerald-600 font-semibold transition-colors underline decoration-emerald-300 hover:decoration-emerald-500">
                        Privacy Policy
                      </a>
                    </label>
                  </div>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            ...
            >
              <rect x="140" y="300" width="170" height="18" rx="6" fill="url(#book1)" />
              <rect x="145" y="280" width="160" height="18" rx="6" fill="url(#book2)" />
              <rect x="150" y="260" width="150" height="18" rx="6" fill="url(#book3)" />
              <rect x="155" y="240" width="140" height="18" rx="6" fill="url(#book4)" />
              
              {/* Book details */}
              <rect x="150" y="302" width="40" height="3" rx="1" fill="rgba(255,255,255,0.6)" />
              <rect x="155" y="282" width="35" height="3" rx="1" fill="rgba(255,255,255,0.6)" />
              <rect x="160" y="262" width="30" height="3" rx="1" fill="rgba(255,255,255,0.6)" />
              <rect x="165" y="242" width="25" height="3" rx="1" fill="rgba(255,255,255,0.6)" />
            </motion.g>
            ...
            >
              <path d="M225 180 L170 210 L170 160 L225 130 L280 160 L280 210 Z" fill="#FFFFFF" stroke="url(#emeraldGradient)" strokeWidth="3" />
              <line x1="225" y1="130" x2="225" y2="210" stroke="url(#emeraldGradient)" strokeWidth="2" />
              
              {/* Book pages with content */}
              <line x1="180" y1="170" x2="210" y2="170" stroke="#D1D5DB" strokeWidth="1.5" />
              <line x1="180" y1="180" x2="205" y2="180" stroke="#D1D5DB" strokeWidth="1.5" />
              <line x1="180" y1="190" x2="215" y2="190" stroke="#D1D5DB" strokeWidth="1.5" />
              <line x1="235" y1="170" x2="265" y2="170" stroke="#D1D5DB" strokeWidth="1.5" />
              <line x1="235" y1="180" x2="260" y2="180" stroke="#D1D5DB" strokeWidth="1.5" />
              <line x1="235" y1="190" x2="270" y2="190" stroke="#D1D5DB" strokeWidth="1.5" />
            </motion.g>
            ...
            >
              <circle cx="225" cy="100" r="30" fill="#FEF3C7" stroke="url(#emeraldGradient)" strokeWidth="3" />
              
              {/* Hair - Modern style */}
              <path d="M200 80 Q225 60 250 80 Q240 65 225 65 Q210 65 200 80 Z" fill="#10B981" />
              <path d="M205 75 Q225 70 245 75 L240 70 Q225 65 210 70 Z" fill="#059669" />
              ...
              {/* Happy smile */}
              <path d="M210 110 Q225 120 240 110" stroke="#1F2937" strokeWidth="2" fill="none" />
              
              {/* Body - Casual student look */}
              <rect x="205" y="130" width="40" height="60" rx="20" fill="url(#emeraldGradient)" />
              
              {/* Backpack - Enhanced */}
              <rect x="180" y="85" width="20" height="30" rx="10" fill="url(#tealGradient)" />
              <rect x="250" y="85" width="20" height="30" rx="10" fill="url(#tealGradient)" />
              <rect x="195" y="80" width="60" height="40" rx="12" fill="url(#darkTeal)" />
              <circle cx="225" cy="100" r="8" fill="rgba(255,255,255,0.3)" />
              
              {/* Arms in welcoming gesture */}
              <ellipse cx="185" cy="155" rx="15" ry="25" fill="#FEF3C7" transform="rotate(-20 185 155)" />
              <ellipse cx="265" cy="155" rx="15" ry="25" fill="#FEF3C7" transform="rotate(20 265 155)" />
            </motion.g>
            ...
            >
              <circle cx="120" cy="120" r="20" fill="url(#blueGradient)" opacity="0.9" />
              <text x="120" y="125" textAnchor="middle" className="text-sm font-bold" fill="#FFFFFF">A+</text>
            </motion.g>
            ...
            >
              <circle cx="330" cy="140" r="18" fill="url(#purpleGradient)" opacity="0.9" />
              <text x="330" y="145" textAnchor="middle" className="text-xs font-bold" fill="#FFFFFF">∑</text>
            </motion.g>
            ...
            >
              <circle cx="100" cy="280" r="15" fill="url(#orangeGradient)" opacity="0.9" />
              <text x="100" y="285" textAnchor="middle" className="text-xs font-bold" fill="#FFFFFF">π</text>
            </motion.g>
            ...
            >
              <circle cx="350" cy="300" r="16" fill="url(#pinkGradient)" opacity="0.9" />
              <text x="350" y="305" textAnchor="middle" className="text-xs font-bold" fill="#FFFFFF">♪</text>
            </motion.g>
            ...
            <motion.g
              ...
              transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
            >
              <path d="M225 130 Q280 150 320 120 Q350 100 380 140" stroke="url(#emeraldGradient)" strokeWidth="3" fill="none" strokeDasharray="8,4" opacity="0.7" />
            ...
            >
              ...
              <rect x="296" y="212" width="8" height="6" rx="2" fill="url(#orangeGradient)" />
              <path d="M296 206 L300 202 L304 206" stroke="#FFFFFF" strokeWidth="1.5" fill="none" />
            </motion.g>
            ...
            >
              <circle cx="80" cy="200" r="25" fill="none" stroke="url(#emeraldGradient)" strokeWidth="4" strokeDasharray="20,5" opacity="0.6" />
              <circle cx="80" cy="200" r="6" fill="url(#emeraldGradient)" />
              <text x="80" y="205" textAnchor="middle" className="text-xs font-bold" fill="#FFFFFF">75%</text>
            </motion.g>
            ...
            >
              <circle cx="370" cy="220" r="20" fill="none" stroke="url(#tealGradient)" strokeWidth="3" strokeDasharray="15,3" opacity="0.6" />
              <circle cx="370" cy="220" r="5" fill="url(#tealGradient)" />
              <text x="370" y="225" textAnchor="middle" className="text-xs font-bold" fill="#FFFFFF">92%</text>
            </motion.g>
            ...
            >
              <path d="M160 60 L162 66 L168 66 L163 70 L165 76 L160 72 L155 76 L157 70 L152 66 L158 66 Z" fill="url(#goldGradient)" opacity="0.9" />
            </motion.g>
            ...
            >
              <path d="M320 50 L321 54 L325 54 L322 57 L323 61 L320 59 L317 61 L318 57 L315 54 L319 54 Z" fill="url(#silverGradient)" opacity="0.8" />
            </motion.g>
            ...
            >
              <path d="M90 350 L91 353 L94 353 L92 355 L93 358 L90 356 L87 358 L88 355 L86 353 L89 353 Z" fill="url(#bronzeGradient)" opacity="0.7" />
            </motion.g>
        ...
        >
          ...
          <p className="text-xs text-emerald-600 font-semibold mt-2">- George R.R. Martin</p>
        </motion.div>
      </motion.div>
    </div>
  );
